...
\begin{figure}[ht] 
	...
	\caption[Riemann Integral] {
		Upper and lower Riemann sums shown for the same sequence shown with light and dark rectangles respectively. 
...
For example, in a multivariate calculus course, Green's theorem is often introduced using differential forms 
