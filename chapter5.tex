...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[scale=4]
		...
		\draw [thick,decorate,decoration={brace,amplitude=10pt},yshift=0.4pt] (-1,1) -- (0,1) 
			node[black,midway,yshift=0.6cm] {$easdf$};
		\draw [thick,decorate,decoration={brace,amplitude=10pt},yshift=0.4pt] (0,1) -- (1,1) 
			node[black,midway,yshift=0.6cm] {$easdf$};
			
		\draw[<->] (-1.5,1.5) -- (-.5,1.5);
		\draw[<->] (-1,1.4) -- (-1, 2.1);
		\draw[thick] (-1.5,1.5) -- (-1.25,1.5) -- (-1.25,2) -- (-.75,2) -- (-.75,1.5) -- (-.5,1.5);
