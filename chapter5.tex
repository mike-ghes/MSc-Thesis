...
or $+\infty$.
So with 4 end-points and 2 possible cases for each, this leads to 16 possible cases of how one-piece functions can be 
convolved.
The proofs follow similar logic for most cases and will not be enumerated here. 
Full derivation can be found in Appendix~\ref{chp:16cases}.
...
While this is of more historical interest, the discrete case is more widely used in digital signal processing.
