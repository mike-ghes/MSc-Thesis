...
\newcommand{\super}{Stephen M. Watt} %supervisor
...
\newcommand{\examo}{Yuri Boykov}  %examining committee (up to four, if less leave blank)
\newcommand{\examt}{Roberto Solis Oba}
\newcommand{\examth}{Greg Reid}
\newcommand{\examf}{}
...
\newcommand{\titl}{Generalized Inclusion-Exclusion}
...
\include{chp1_introduction}
\include{chp2_hybridset}
\include{chp3_matrices}
\include{chp4_integration}
\include{chp5_stokes}
\include{chp6_convolution}
\include{chp7_conclusion}
