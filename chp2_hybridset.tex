...
\todo[inline]{``Should say following development of the paper and give reference.''}
...
\todo[inline]{``What does it mean for a binary operator to be invertible?''}
...
\todo[inline]{``Give an outline of what is to come explaining what is in prior papers, and what is newly explained here.''}
