...
\todo[inline]{
Common practice to use ``$\ldots$'' in vectors and matrices.
}
...
\todo[inline]{
For any oriented interval, at most one interval term will be non-empty.
However when using symbolic terms, 
...
\todo[inline]{$U\cdot V^T$ instead of $U^T \cdot V$. But should be part of matrix multiplication?}
