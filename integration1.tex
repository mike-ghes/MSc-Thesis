...
\end{tikzpicture}
\end{figure}
\todo[inline]{float faces off of cube + fill}
...
These are all conceptual tools, subtraction may not have any physical interpretation (as we will see later with manifold points?).
